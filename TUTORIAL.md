- [Введение](#orgf905e71)
- [TCP и UDP](#orgc7cf340)
  - [Transmission Control Protocol — TCP](#org2f10ea7)
  - [User Datagram Protocol — UDP](#orge0eabe3)
- [Самый простой сервер](#org6345ad7)
- [Прощаемся с синхронностью](#org298bba5)
...
<a id="org1da7fd7"></a> Теперь давайте взглянем на следующий [исходный код](./code/simple_server.cpp):
...
Вспомним [код из предыдущего раздела](#org1da7fd7), в котором используется синхронный подход:
