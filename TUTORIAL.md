- [Введение](#org901ee97)
- [TCP и UDP](#org87d860b)
  - [Transmission Control Protocol — TCP](#org5fdd917)
  - [User Datagram Protocol — UDP](#org081fb5f)
- [Самый простой сервер](#orgbd763f4)
- [Прощаемся с синхронностью](#org2ddc8d5)
- [Асинхронный TCP-сервер](#orgfce9182)
...
<a id="org0155026"></a> Теперь давайте взглянем на следующий [исходный код](./code/simple_server.cpp):

```cpp
#include <boost/asio.hpp>                                                            (simple_server)
...
Вспомним [код из предыдущего раздела](#org0155026), в котором используется синхронный подход:
