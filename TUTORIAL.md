...
<a id="transmission-control-protocol--tcp"></a>
...
<a id="user-datagram-protocol--udp"></a>
...
<a id="org3b69bd7"></a> Теперь давайте взглянем на следующий [исходный код](./code/simple_server.cpp):
...
<a id="прощаемся-с-синхронностью"></a>
...
Вспомним [код из предыдущего раздела](#org3b69bd7), в котором используется синхронный подход:
